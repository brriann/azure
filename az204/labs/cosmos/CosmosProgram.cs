namespace AdventureWorks.Upload
{
    ...
    {
        private const string EndpointUrl = "https://asdf.documents.azure.com:443/";
        private const string AuthorizationKey = "accessKey";
        ...
        private const string JsonFilePath = "_AZ_204\\Labs\\04\\Starter\\AdventureWorks\\AdventureWorks.Upload\\models.json";
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                // INFO, had to create container manually through Portal, this section 400'd
